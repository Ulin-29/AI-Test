...
DATASET_DIR = 'dataset'
# Kualitas gambar (dots per inch) ditingkatkan untuk detail yang lebih baik
DPI = 300

def preprocess_image(pix):
    """
    Fungsi untuk membersihkan dan meningkatkan kualitas gambar.
    """
        ...
        if os.path.isdir(category_source_path):
            ...
            for pdf_filename in tqdm(pdf_files, desc=f"  -> Konversi {category_name}"):
                ...
                try:
                    ...
                    print(f"\n[Peringatan] Gagal memproses file '{pdf_filename}': {e}")
